...
function customizer ($customize) {
	...
	$ctmz_tree = array(
		...
		array(
			...
			"controls" => array(
				array(
					"label" => "Cor primária de fundo",
					"descricao" => "(Você deve escolher a cor secundária para aplicar esse efeito)",
					"default" => "",
					"tipo_de_controle" => "paleta_de_cores",
					"setting" => "videos_primary_color",
				),
				array(
					"label" => "Cor secundária de fundo",
					"descricao" => false,
					"default" => "",
					"tipo_de_controle" => "paleta_de_cores",
					"setting" => "videos_secondary_color",
				),
				array(
					"label" => "Cor primária dos itens",
					"descricao" => "(Você deve escolher a cor secundária para aplicar esse efeito)",
					"default" => "",
					"tipo_de_controle" => "paleta_de_cores",
					"setting" => "videos_click_primary_color",
				),
				array(
					"label" => "Cor secundária dos itens",
					"descricao" => false,
					"default" => "",
					"tipo_de_controle" => "paleta_de_cores",
					"setting" => "videos_click_secondary_color",
				),
			),
		),
		//Serviços
